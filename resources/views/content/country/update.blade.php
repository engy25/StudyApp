    ...
    <div class="card-body">
        <form method="post" action="{{ route('countries.update', $country->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{ $country->name }}" class="form-control" id="name_en" name="name_en" required>
                @error('name_en')
            ...
            <div class="mb-3">
              ...
              <input type="text" value="{{ $country->translations()->where("locale","ar")->first()->name }}" class="form-control" id="name_ar" name="name_ar" required>
              @error('name_ar')
              <div class="alert alert-danger" role="alert">
                  {{ $message }}
              </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" value="{{ $country->country_code}}" class="form-control" id="country_code" name="country_code" required>
            @error('country_code')
            <div class="alert alert-danger" role="alert">
                {{ $message }}
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    ...
                    @if($country->flag)
                    <div>
                        <img id="image-preview" src="{{ asset($country->flag) }}" alt="Store Image" style="max-width: 200px;">
                    </div>
                    @else
                    <div>
